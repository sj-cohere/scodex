...
#[derive(Debug, Parser)]
#[command(bin_name = "scodex plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin add",
    after_help = "Examples:\n  scodex plugin add sample@debug\n  scodex plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin list",
    after_help = "Examples:\n  scodex plugin list\n  scodex plugin list --marketplace debug\n  scodex plugin list --json\n  scodex plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin remove",
    after_help = "Examples:\n  scodex plugin remove sample@debug\n  scodex plugin remove sample --marketplace debug"
)]
