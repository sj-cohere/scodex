...
#[derive(Debug, Parser)]
#[command(bin_name = "scodex plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin marketplace add",
    after_help = "Examples:\n  scodex plugin marketplace add ./path/to/marketplace\n  scodex plugin marketplace add owner/repo --ref main\n  scodex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "scodex plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin marketplace upgrade",
    after_help = "Examples:\n  scodex plugin marketplace upgrade\n  scodex plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "scodex plugin marketplace remove",
    after_help = "Example:\n  scodex plugin marketplace remove debug"
)]
